                                ...
                                <td>
                                    @foreach ($permission as $index => $perm)
                                        @if ($perm->group == $value->group)
                                            <input type="checkbox" name="permission[]" onclick='permission("permission_{{ $perm->id }}","{{ $value->group }}")' id="permission_{{ $perm->id }}" class="all permission_{{ $value->group }} {{ $value->group }}" value="{{ $perm->id }}">
